    ...
    <body id="page">
        ...
        <div id="banniere">
            ...
            <div id="liens">
                ...
                <div>
                    <a href="/contact?prev=investor&amp;button=false" class="sous-liens">
                        Contact
                    </a>
                </div>
            </div>
            ...
            <div class="menu-toggle">
                ...
                <ul class="menu">
                    ...
                    <li class="liens"><a href="/contact?prev=investor&amp;button=false">Contact</a></li>
                ...
                <tr>
                    <td class="special-td">
                        <div class="photo-investor">
                            <img src="/img/Nebot%20Cannelle%20-%20Perpignan-1-R.jpg" class="img-1" alt="">
                        </div>
                    </td>
                    <td>
                        <div class="para">
        ...
        <div class="contact" id="contact-welcome">
            <button class="contact-button" id="contact-button-index-1"
                onclick="window.location.href = '/contact?prev=investor&amp;button=true';">CONTACTEZ-NOUS</button>
        </div>
        <div class="promotion">
            Si vous avez des questions, <a href="/contact">contactez-nous</a> et n'oubliez pas d'aller faire un tour sur notre <a href="https://faq.lotixam.fr/">FAQ</a> !
        </div>
        <div class="attention">
