    ...
    <body id="page">
        ...
        <div id="banniere">
            ...
            <div id="liens">
                ...
                <div>
                    <a href="/contact?prev=seller&amp;button=false" class="sous-liens">
                        Contact
                    </a>
                </div>
            </div>
            ...
            <div class="menu-toggle">
                ...
                <ul class="menu">
                    ...
                    <li class="liens"><a href="/contact?prev=seller&amp;button=false">Contact</a></li>
        ...
        <div class="contact" id="contact-welcome">
            <button class="contact-button" id="contact-button-index-1"
                    onclick="window.location.href = '/contact?prev=seller&amp;button=true';">CONTACTEZ-NOUS</button>
        </div>
    </body>
