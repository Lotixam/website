...
return [
    ...
    */
    ...
    'payload' => [
        ...
        // Filament admin : un seul batch peut inclure beaucoup de sous-composants (tables, widgets…).
        // La valeur par défaut (20) provoque des réponses d’erreur non-JSON côté client → JSON.parse échoue.
        'max_components' => max(1, (int) (env('LIVEWIRE_MAX_COMPONENTS') ?: 80)),
    ],
];
